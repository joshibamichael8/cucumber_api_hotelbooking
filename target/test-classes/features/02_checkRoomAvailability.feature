...
#Below criteria are covered in the above scenario with different date combinations:
 #specific dates
 #single night stay
 #far future dates
 #extended period (more than 30 days)
 #same day check-in and check-out (accepted in this application)
# ==================== NEGATIVE SCENARIOS ====================
...
#       The above scenario is getting failed because the API is accepting checkout date 
